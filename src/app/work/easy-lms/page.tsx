...
export const metadata: Metadata = {
	title: 'Easy LMS - case study by LabelNoir',
};

const Page = () => (
	<main>
		<Hero background="/cases/kcb/hero.jpg" dark={false} className="object-[50%,16.25%]">
			<h1>Guiding educators to their next LMS</h1>
		</Hero>
		...
		>
			<p className="intro">
				Easy LMS is a Learning Management System, similar to the more well known CMS, but
				for educational courses. With a good growth and a main focus on their SaaS platform,
				the website lost focus
			</p>
			<p className="intro">
